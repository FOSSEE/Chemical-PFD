    ...
    def saveImage(self):
        if self.mdi.currentSubWindow():
            ...
            if currentDiagram:
                ...
                msg_box.addButton("SVG", QMessageBox.NoRole)  # Added SVG option

                choice = msg_box.exec_()

                if choice == 0:  # User chose "PNG"
                    fileExtension = ".png"
                elif choice == 1:  # User chose "JPEG"
                    fileExtension = ".jpg"
                else:  # User chose "SVG"
                    fileExtension = ".svg"
                ...
                if file_dialog.exec_():
                    ...
                    if fileExtension == ".svg":
                        ...
                        svgGenerator.setSize(
                            QSize(int(currentDiagram.sceneRect().width()), int(currentDiagram.sceneRect().height())))
                        svgGenerator.setViewBox(QRectF(currentDiagram.sceneRect()))
                        ...
                        currentDiagram.render(svgPainter)
                        svgPainter.end()
                    else:
